...
urls = [
    "https://www.eeworld.com.cn/emp/Icbank/a422103.jspx",
    "https://www.eeworld.com.cn/emp/aes/a420767.jspx",
    "https://www.eeworld.com.cn/emp/Xilinx/a422939.jspx",
]
...
for url in urls:
    ...
    summary = "用户指定本篇为感兴趣，已按文章时间入档。待后续逐篇精读后补充技术向摘要、问答要点与关注重点。"
    focus = "- 本条为用户显式标记感兴趣\n- 当前先完成按文章时间归档\n- 后续逐篇阅读后补全技术结论"
    cmd = [
